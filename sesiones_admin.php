...
<div class="contenedor">
		...
		<div class="contenedor">
			...
			<div id="menu_sesion">
				<ul class="idiomas">
					<li><a href="sesiones_admin_ingles.php">Inglés</a></li>
					<li class="slash">/</li>
					<li><a href="sesiones_admin.php">Español</a></li>
				</ul>
				<ul class="sesion">
					<?php ob_start();
		...
		<div class="separador"></div>	
			...
			<?php ob_start();
					...
					include("solucion_contratos.php");
					include("solucion_cuentas.php");
					include("solucion_difusion.php");
					include("solucion_aprobacion.php");
				ob_end_flush();?>
				<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
			</div>
