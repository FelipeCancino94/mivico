<!--acá va el contenido de la opcion de solucion4-->
				...
				<div class="contenido_solucion4">
					<div class="difusion">
						...
						<textarea name="publi" rows="4" cols="70" placeholder="   Make your post here..." maxlength="150" require></textarea>
						<input type="submit" name="publicar" value="publish" id="boton_publicar">
						</form> 
					</div>
					<div class="separador"></div>
											
						<?php
						include("salida_difusion_ingles.php");
						?>
